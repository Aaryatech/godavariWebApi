...
public interface GetOrderDetailRepo extends JpaRepository<GetOrderDetail, Integer> {
	...
	@Query(value = "SELECT d.*,i.item_eng_name,i.item_mar_name,i.item_eng_desc,i.item_mar_desc,u.uom_name FROM t_order_detail d ,m_item i,m_uom u WHERE d.item_id=i.item_id and d.order_header_id=:orderHeaderId AND u.uom_id=i.item_uom_id", nativeQuery = true)
	...
	@Query(value = "SELECT d.order_detail_id,d.order_header_id,d.item_id,d.item_rate,SUM(d.order_qty) AS order_qty,d.hub_qty,"
			...
			+ "i.item_eng_name,i.item_mar_name,i.item_eng_desc,i.item_mar_desc,u.uom_name FROM t_order_detail d ,m_item i,m_uom u "

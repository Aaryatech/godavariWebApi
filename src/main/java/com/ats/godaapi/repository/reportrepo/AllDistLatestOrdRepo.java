...
public interface AllDistLatestOrdRepo extends JpaRepository<AllDistLatestOrd, Integer>{
	...
	List<AllDistLatestOrd> getAllDistLastestOrdList(@Param("distId") int distId);

...
@Entity
public class GetOrderDetailForSupervisor {
	...
	public String toString() {
		return "GetOrderDetailForSupervisor [orderDetailId=" + orderDetailId + ", orderHeaderId=" + orderHeaderId
				+ ", itemId=" + itemId + ", itemRate=" + itemRate + ", orderQty=" + orderQty + ", hubQty=" + hubQty
				+ ", msQty=" + msQty + ", itemTotal=" + itemTotal + ", deliverQty=" + deliverQty + ", itemCgst="
				+ itemCgst + ", itemSgst=" + itemSgst + ", itemIgst=" + itemIgst + ", itemBasicValue=" + itemBasicValue
				+ ", itemEngName=" + itemEngName + ", itemMarName=" + itemMarName + ", itemEngDesc=" + itemEngDesc
				+ ", itemMarDesc=" + itemMarDesc + ", uomName=" + uomName + ", itemWt=" + itemWt + ", catId=" + catId
				+ "]";
	}
